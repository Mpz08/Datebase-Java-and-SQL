...
public class database 
{
    ...
    public int addItemToDatabase(String itemName, int itemWidth, int itemDepth, int itemHeight, int roomNumber)
    {
        ...
        return itemID;
    // chesk Available Rooms (Return a list of room that aren't assiged to a custumer)
    import java.util.ArrayList;
    import java.util.List;
    
    public class RoomManager {
        
        // Function to find available rooms that aren't assigned to any customer
        public List<Integer> availableRooms(List<Integer> allRooms, List<Integer> assignedRooms) {
            List<Integer> available = new ArrayList<>();
            
            // Iterate through allRooms
            for (int room : allRooms) {
                // Check if room is not in assignedRooms list
...
public class RoomManager {
    ...
    public static void main(String[] args) {
        ...
        // List of all rooms
        List<Integer> allRooms = List.of(101, 102, 103, 104, 105);
        
        // List of rooms already assigned to customers
        List<Integer> assignedRooms = List.of(101, 104);
        
        // Find available rooms
        List<Integer> available = roomManager.availableRooms(allRooms, assignedRooms);
